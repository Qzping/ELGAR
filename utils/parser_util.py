...
def parse_and_load_from_model(parser):
    ...
    # test file should be different from train file
    args_to_overwrite.remove('filename')
    args_to_overwrite.remove('datapath')

    # load args from model
    model_path = get_model_path_from_args()
    # args_path = os.path.join(os.path.dirname(model_path), 'args.json')
    args_path = os.path.join(os.path.dirname(os.path.dirname(model_path)), 'args.json')
...
def add_base_options(parser):
    ...
    group.add_argument("--seed", default=13, type=int, help="For fixing random seed.")
...
def add_diffusion_options(parser):
    ...
    group.add_argument("--timestep_respacing", default='', type=str,
                       help="How to skip timesteps. Could be a list of numbers, a string containing comma-separated numbers, or ddimN from the ddim paper")


def add_model_options(parser):
    group = parser.add_argument_group('model')
    # group.add_argument("--arch", default='trans_enc',
    #                    choices=['trans_enc', 'trans_rot_enc', 'trans_dec', 'gru'], type=str,
    #                    help="Architecture types as reported in the paper.")
    group.add_argument("--arch", default='trans_enc', type=str,
                       help="Architecture types as reported in the paper.")
    ...
    group.add_argument("--lambda_vel", default=1.0, type=float, help="Joint rotation velocity loss.")
    group.add_argument("--lambda_vel_rcxyz", default=1.0, type=float, help="Joint position velocity loss.")
    group.add_argument("--lambda_accel_rcxyz", default=0, type=float, help="Joint position acceleration loss.")
    group.add_argument("--lambda_hicl", default=2, type=float, help="Hand interative Contact loss.")
    group.add_argument("--lambda_bicl", default=3, type=float, help="Bow interative Contact loss.")
    group.add_argument("--lambda_fc", default=1.0, type=float, help="Foot contact loss.")
    group.add_argument("--cond_mode", default='audio', choices=['instrument', 'audio'], type=str,
                       help="Definition of the conditional input, instrument or audio.")
    group.add_argument("--audio_type", default='jukebox', choices=['jukebox', 'wav2clip'], type=str,
                       help="Type of the audio encoded features (when cond_mode is audio), jukebox or wav2clip.")
    group.add_argument("--norm_first", default=True, type=bool, help="Whether to norm first in Transformer Encoder Layer or not")
    group.add_argument("--use_rotary", default=False, type=bool, help="Whether to use RoPE or not")


def add_data_options(parser):
    group = parser.add_argument_group('dataset')
    group.add_argument("--dataset", default='spd', choices=['humanml', 'kit', 'humanact12', 'uestc', 'spd'], type=str,
                       help="Dataset name (choose from list).")
    group.add_argument("--data_dir", default="", type=str,
                       help="If empty, will use defaults according to the specified dataset.")
    group.add_argument("--datapath", required=True, type=str,
                       help="Path to train/test data.")
    group.add_argument("--filename", default={}, type=json.loads,
...
def add_training_options(parser):
    ...
    group.add_argument("--num_frames", default=90, type=int,
                       help="Limit for the maximal number of frames. In HumanML3D and KIT this field is ignored.")
    group.add_argument("--resume_checkpoint", default="", type=str,
                       help="If not empty, will start from the specified checkpoint (path to model###.pt file).")
    group.add_argument("--train_mode", default="total", type=str,
                       help="'total' or 'partial': use all data for training or train split data for training")
    group.add_argument("--use_awl", default=False, type=bool,
                       help='whether to use Automatic Weighted Loss')
